...
public class Brew : ModuleBase
{
    ...
    protected override Task ExecuteAsync(CancellationToken token = default)
    {
        ...
        Logger.LogInformation(
            "Events enable decoupled communication: publishers don't know subscribers"
        );
        Logger.LogInformation("===========================================================");
        Logger.LogInformation("");
        ...
        Logger.LogInformation(
            "Subscriptions complete: EmailNotifier, InventoryManager, AuditLogger registered"
        );
        Logger.LogInformation("");
        ...
        Logger.LogInformation(
            "✓ Decoupling: OrderProcessor doesn't know about EmailNotifier/InventoryManager"
        );
