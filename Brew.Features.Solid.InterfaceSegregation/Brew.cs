...
public class Brew : ModuleBase
{
    ...
    protected override Task BeforeAsync(CancellationToken token = default)
    {
        ...
        try
        {
            ...
            Console.WriteLine(
                "✗ Violates ISP: Classes shouldn't depend on methods they don't use\n"
            );
        }
    ...
    protected override Task AfterAsync(CancellationToken token = default)
    {
        ...
        Console.WriteLine(
            "Solution: Segregated interfaces - heroes only implement what they can do\n"
        );
        ...
        Console.WriteLine(
            "✓ Follows ISP: Clients shouldn't be forced to depend on methods they don't use"
        );
